...
namespace TaskManagement
{
    public partial class ProjectForm : Form
    {
        ...
        public ProjectForm(int mode, string fullname, DashBoard dashBoard, string username, int projectid)
        {
            InitializeComponent();
        ...
        private void ProjectForm_Load(object sender, EventArgs e)
        {
            ...
            var projects = _project.GetAll().Where(p => p.Uid == userID && p.ProjectId == projectID);
